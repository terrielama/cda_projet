...
const NotFound = () => {
    ...
    const StyledWrapper = styled.div`
      ...
      .antenna_shadow {
        ...
        box-shadow:
          inset 0px 16px rgb(28, 28, 28),
          inset 0px 16px 1px 1px rgb(28, 28, 28);
        -moz-box-shadow:
          inset 0px 16px rgb(36, 36, 36),
          inset 0px 16px 1px 1pxrgb(26, 26, 26);
      }
      .antenna::after {
        content: "";
        position: absolute;
      ...
      .tv {
        ...
        box-shadow: inset 0.2em 0.2emrgb(64, 64, 64);
      }
      .tv::after {
        content: "";
        position: absolute;
      ...
      .display_div {
        ...
        justify-content: center;
        border-radius: 15px;
        box-shadow: 3.5px 3.5px 0pxrgb(0, 0, 0);
      }
      .screen_out {
        width: auto;
        height: auto;
      ...
      .buttons_div {
        ...
        flex-direction: column;
        row-gap: 0.75em;
        box-shadow: 3px 3px 0px rgb(130, 130, 130);
      }
      .b1 {
        width: 1.65em;
        height: 1.65em;
        ...
        border: 2px solid black;
        box-shadow:
          inset 2px 2px 1px rgb(214, 214, 214),
          -2px 0px rgb(62, 62, 62),
      ...
      .b2 {
        ...
        border: 2px solid black;
        box-shadow:
          inset 2px 2px 1px rgb(162, 162, 162),
          -2px 0px rgb(71, 71, 71),
          -2px 0px 0px 1px black;
      }
      .b2::before {
        content: "";
      ...
      .g13 {
        ...
        background-color:rgb(108, 108, 108);
        border: 2px solid black;
        box-shadow: inset 1.25px 1.25px 1px rgb(185, 185, 185);
      }
      .speakers .g {
        width: auto;
        height: 2px;
